...
class Americano extends Coffee {
    hotWaterMl;
    constructor(size, isDecaf, hotWaterAmount) {
        super(size, isDecaf);
        this.hotWaterMl = hotWaterAmount;
    }
    description() {
        console.log(`A ${this.size} Americano with ${this.hotWaterMl} ml of hot water.`);
    }
}
let myAmericano = new Americano("medium", false, 60);
console.log(myAmericano.description());
